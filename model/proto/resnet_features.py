...
def resnet18_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        my_dict = model_zoo.load_url(
            model_urls['resnet18'], model_dir=model_dir)
...
def resnet34_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        my_dict = model_zoo.load_url(
            model_urls['resnet34'], model_dir=model_dir)
        my_dict.pop('fc.weight')
        my_dict.pop('fc.bias')
        model.load_state_dict(my_dict, strict=False)
    return model
...
def resnet50_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        my_dict = model_zoo.load_url(
            model_urls['resnet50'], model_dir=model_dir)
        my_dict.pop('fc.weight')
        my_dict.pop('fc.bias')
        model.load_state_dict(my_dict, strict=False)
    return model
...
def resnet101_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        my_dict = model_zoo.load_url(
            model_urls['resnet101'], model_dir=model_dir)
        my_dict.pop('fc.weight')
        my_dict.pop('fc.bias')
        model.load_state_dict(my_dict, strict=False)
    return model
...
def resnet152_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        my_dict = model_zoo.load_url(
            model_urls['resnet152'], model_dir=model_dir)
        my_dict.pop('fc.weight')
        my_dict.pop('fc.bias')
        model.load_state_dict(my_dict, strict=False)
    return model
